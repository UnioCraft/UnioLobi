package me.uniodex.uniolobi.utils.packages.reflection.resolver;
...
public class MethodResolver extends MemberResolver<Method> {
	...
	public MethodWrapper<?> resolveSignatureWrapper(String... signatures) {
		return new MethodWrapper<Object>(resolveSignatureSilent(signatures));
	}
	...
	@Override
	public MethodWrapper<Object> resolveIndexWrapper(int index) {
		return new MethodWrapper<>(resolveIndexSilent(index));
	}

	public MethodWrapper<Object> resolveWrapper(String... names) {
		return new MethodWrapper<>(resolveSilent(names));
	}

	public MethodWrapper<Object> resolveWrapper(ResolverQuery... queries) {
