...
import me.uniodex.uniolobi.utils.packages.reflection.resolver.ResolverQuery;
...
public class DataWatcher {
	...
	public static class V1_8 {
		...
		public static Object setValue(Object dataWatcher, int index, Object value) throws ReflectiveOperationException {
			...
			Map<Integer, Object> map = (Map<Integer, Object>) DataWatcherFieldResolver.resolveByLastType(Map.class).get(dataWatcher);
