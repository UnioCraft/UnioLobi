...
import me.uniodex.uniolobi.utils.packages.bossbar.reflection.ClassBuilder;
import me.uniodex.uniolobi.utils.packages.bossbar.reflection.NMSClass;
import me.uniodex.uniolobi.utils.packages.reflection.minecraft.DataWatcher;

import static me.uniodex.uniolobi.utils.packages.reflection.minecraft.DataWatcher.V1_9.ValueType.*;
...
public class EntityBossBar extends BukkitRunnable implements BossBar {
	...
	protected EntityBossBar(Player player, String message, float percentage, int timeout, float minHealth) {
		...
		if (timeout > 0) {
			...
			this.runTaskTimer(Main.instance, 20, 20);
		}
	}
